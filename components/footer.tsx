...
export default function Footer() {
  ...
  return (
    <section className="bg-gray-100 pt-16">
      <footer className="mx-2.5 mb-2.5 rounded-3xl bg-[#1A1E2E] text-white">
        <div className="mx-auto max-w-[1200px] px-6 py-12">
          <div className="flex flex-col justify-between gap-8 md:flex-row md:items-start">
            ...
            {/* Navigation */}
            <div>
              <h3 className="mb-4 text-sm font-medium text-gray-400">QUICK LINKS</h3>
          ...
          <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
            <div className="font-mono text-xs text-gray-400">© 2025 DataProof Holdings Limited</div>

            {/* Social icons */}
            <div className="flex items-center space-x-4">
              {/* Telegram */}
              <Link 
                href="https://t.me/DataProof_Official" 
              ...
              {/* Twitter X */}
              <Link 
                href="https://x.com/DataProof_COIN" 
                className="text-gray-400 hover:text-white"
                target="_blank"
                rel="noopener noreferrer"
              >
                <svg viewBox="0 0 1200 1227" fill="none" className="h-5 w-5">
                  <path
